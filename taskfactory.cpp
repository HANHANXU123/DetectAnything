...
#include "anomalydetect.h" // AnomalyDetect（位于 anomaly/ 子目录，INCLUDEPATH 已含）
...
std::unique_ptr<ITask> TaskFactory::create(TaskType type)
{
    ...
    case TaskType::Anomaly:
        return std::make_unique<AnomalyDetect>();
    }
    return nullptr;
}
...
QString TaskFactory::enginePathFor(TaskType type)
{
    ...
    case TaskType::Anomaly:     return QStringLiteral("models/anomalyDetect/model.engine");
    }
    return QString();
}
